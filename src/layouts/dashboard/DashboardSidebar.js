...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar, navData }) {
  ...
  const renderContent = (
    ...
    >
      ...
      >
        <Stack direction="row" alignItems="center" justifyContent="center">
          <Box component={RouterLink} to="/" sx={{ display: 'inline-flex' }}>
            <img alt="Logo" src={Logo} style={{ width: 90, height: 70 }} />
          </Box>
          {!isCollapse && <Typography sx={{ mx: 2, fontSize: 25 }}>Scheduly</Typography>}
      ...
      <NavSection navData={navData} navConfig={sidebarConfig} isShow={!isCollapse} />

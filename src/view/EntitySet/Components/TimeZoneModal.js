...
const TimeZone = ({ setZone, timezoneList }) => {
  const style1 = {
    position: 'absolute',
    top: '50%',
    left: '50%',
  ...
  return (
    <>
      <>
        <MIconButton ref={menuRef} style={{ width: '50px', height: '50px' }} onClick={handleClick}>
        ...
        <Modal open={openCopyFormModal} onClose={handleClose}>
          <Card sx={style1}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
              <Button sx={{ mr: 3 }} type="submit" variant="contained" color="primary" onClick={handleOnClick}>
                Ok
              </Button>
